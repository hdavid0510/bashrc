...
### Default cursor line # on editing this file via "eb"
EB_START_LINE=116
...
alias au="sudo apt update ; sudo apt upgrade -y ; sudo apt autoremove -y; sudo apt clean; echo Updating snaps; sudo snap refresh; oldsnap_remove"
alias auf="sudo apt update; sudo apt -y -o Dpkg::Options::="--force-overwrite" upgrade; sudo apt autoremove -y; sudo apt clean"


## SSH Startup notification enabled on Byobu
